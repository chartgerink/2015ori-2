...
We provide descriptions of blocks 2-5 of the interviews (see [Methods](#methods) for a summary of the blocks).
...
Prior to fabricating the data, the participant prepared by investigating existing literature on the Stroop task. The preparation by the participant focused on assessing the scales and typical moments (e.g., standard deviations) of the response time measures. This preparation did not span more than half an hour and did not extend to investigating how previous cases of data fabrication were detected ("I thought it was a little bit cheating also to do it").

The participant spent approximately two hours on actually fabricating the data, spanning two days. The majority of the data fabrication took place on the first day and finished on the second day. The participant indicated that this was "not that much effort" from their part and that additional effort could have been put in by trying to investigate how we might go about trying to detect the fabricated data ("it was too much effort to do it").
